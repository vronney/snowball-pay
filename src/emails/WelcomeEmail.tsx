        ...
        <Container style={{ maxWidth: '560px', margin: '40px auto', background: '#ffffff', borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(15,23,42,0.08)' }}>
          ...
          <Section style={{ padding: '36px 40px' }}>
            ...
            <Section style={{ background: '#f0f9ff', borderRadius: '12px', padding: '20px 24px', border: '1px solid rgba(37,99,235,0.15)', marginBottom: '28px' }}>
              <Text style={{ fontSize: '13px', fontWeight: 700, color: '#2563eb', textTransform: 'uppercase', letterSpacing: '0.08em', margin: '0 0 6px' }}>
                Step 1 of 3
              </Text>
          ...
          <Section style={{ background: '#f8fafc', padding: '20px 40px', borderTop: '1px solid rgba(15,23,42,0.07)' }}>
            <Text style={{ fontSize: '12px', color: '#94a3b8', margin: 0, textAlign: 'center' }}>
              ...
              <br />You&apos;re receiving this because you created an account.
            </Text>
          </Section>
        </Container>
      </Body>
