...
const featured = [
  {
    accent: '#2563eb', bg: 'rgba(37,99,235,0.06)',  border: 'rgba(37,99,235,0.12)', shadow: 'rgba(37,99,235,0.12)',
    num: '01', Icon: IconSnowball, title: 'Snowball Strategy',
    ...
    detail: 'Proven to accelerate payoff velocity by up to 40%',
  },
  {
    accent: '#059669', bg: 'rgba(5,150,105,0.06)',  border: 'rgba(5,150,105,0.12)', shadow: 'rgba(5,150,105,0.12)',
    num: '02', Icon: IconChart,    title: 'Real-Time Progress',
    ...
    detail: 'Visual feedback makes consistency effortless',
  },
];
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '24px', position: 'relative' }}>
                <div
                  ...
                  style={{ background: f.bg, border: `1px solid ${f.border}`, color: f.accent, boxShadow: `0 4px 16px ${f.shadow}` }}
                >
                  <f.Icon />
                </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(226px, 1fr))', gap: '16px' }}>
          {compact.map((f) => (
            <div
              ...
              style={{ borderRadius: '16px', padding: '26px', cursor: 'default', position: 'relative', overflow: 'hidden' }}
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                <div
                  className="lp-feat-icon"
                  style={{ width: '40px', height: '40px', borderRadius: '11px', background: f.bg, border: `1px solid ${f.border}`, color: f.accent }}
                >
                  <f.Icon />
                </div>
