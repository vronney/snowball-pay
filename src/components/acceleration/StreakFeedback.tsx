...
const LEVEL_COLORS: Record<
  Level,
  { bg: string; borderLeft: string; border: string; text: string }
> = {
  excellent: {
...
export default function StreakFeedback({
  streak,
  feedback,
}: StreakFeedbackProps) {
  return (
    ...
    >
      ...
      <div
        style={{
          ...
          alignItems: "center",
          gap: "8px",
          background: streak >= 1 ? "rgba(37,99,235,0.06)" : "#f8fafc",
          border: `1px solid ${streak >= 1 ? "rgba(37,99,235,0.2)" : "rgba(15,23,42,0.07)"}`,
          borderRadius: "8px",
          padding: "10px 14px",
          flexShrink: 0,
        }}
      >
        <Flame
          size={18}
          style={{ color: streak >= 1 ? "#2563eb" : "#cbd5e1" }}
        />
        <div>
          <div
            style={{
