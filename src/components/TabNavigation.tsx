...
export default function TabNavigation({ activeTab, onTabChange }: TabNavigationProps) {
  ...
  return (
    <nav className="max-w-4xl mx-auto px-6 mb-6 pt-4">
      <div style={{ display: 'flex', gap: '3px', background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '12px', padding: '4px', width: 'fit-content' }}>
        {tabs.map((tab) => {
          const Icon = tab.icon;
