...
import TemplateDownload from "@/components/learn/TemplateDownload";
...
export const metadata: Metadata = {
  ...
  description:
    "Download a free debt payoff plan template (Excel, Google Sheets, or CSV) with a debt list, payoff-order guide, and 24-month tracker. No email required.",
  ...
  return (
    <>
      ...
      >
        ...
        <section
          style={{ padding: "72px 24px 10px", backgroundColor: "#f8fafc" }}
        >
          <TemplateDownload source="learn_template_hero" />
        </section>
        ...
        <LearnInlineCTA
          headline="Prefer the math done for you?"
          body="The free calculator is the interactive version of this template — enter your debts and get the month-by-month schedule and your debt-free date instantly. No account required."
        ...
        >
          <div style={{ maxWidth: "600px", margin: "0 auto" }}>
            ...
            >
              SnowballPay automates the first four steps in under 2 minutes. Add
              your debts, choose a strategy, and get the full month-by-month
