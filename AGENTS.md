...
Product / Brand Tone
From .agents/product-marketing-context.md (line 142):
Tone: calm, practical, encouraging
Style: direct, plain-language, explain numbers in context
Personality: clear, steady, trustworthy, disciplined, supportive
Use: clear plan, debt-free date, payoff order, momentum, track progress, realistic, flexible
Avoid: guaranteed results, instant debt elimination, get-rich-quick, shame-based language
Visual / UI Rules
From DESIGN.md (line 10):
Mood: clear, direct, unhurried
Product should feel built for real people carrying debt, not finance nerds
Read DESIGN.md before visual/UI work
Use Geist, DM Sans, and Geist Mono
Use #2563eb only for CTAs, progress, and active states
Light mode only
Avoid purple gradients, generic 3-column icon grids, centered-everything layouts, gradient CTA buttons, and uniform rounded “AI-looking” UI
General Agent Work Rules
From CLAUDE.md (line 27):
Prefer small, single-purpose components and utilities
Keep server mutations in API routes or server-safe modules
Validate inbound payloads, ideally with Zod
Avoid destructive git/file operations unless explicitly requested
Keep changes scoped and reversible
Run npm run lint and npm run build before finalizing major edits
Technical Rules
From .agents/technical-learnings.md (line 10):
Use Next.js next/navigation and next/link, not react-router-dom
Prefer native Intl for date/currency formatting
Keep helper functions/types private unless other files actually import them
Delete dead files, stale components, and unused utilities when refactoring
Strategy / Critique Tone
Your active skill, .agents/skills/business-idea-sparring-partner/SKILL.md (line 249), says agents should be:
Blunt, credible, and commercially grounded
Honest without being insulting
Specific, not vague
Not a cheerleader
Skeptical of weak differentiation, AI-for-AI’s-sake, broad MVPs, retention risk, and unrealistic monetization
